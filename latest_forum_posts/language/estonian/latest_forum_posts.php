...
//Time ago
define('_ONE_SECOND_AGO', '1 sekund tagasi');
define('_SECONDS_AGO', '%s sekundit tagasi');

define('_ONE_MINUTE_AGO', '1 minut tagasi');
...
define('_YEARS_AGO', '%s aastat tagasi');

define('_LONG_TIME_AGO', 'kaua aega tagasi');